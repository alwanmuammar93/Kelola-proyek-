<style>
    /* ========== SIDEBAR KASIR STYLES - WITH DARK THEME SUPPORT ========== */
    * {
        margin: 0;
        padding: 0;
...
<div class="rab-sidebar" id="rabSidebar">
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('kasir.index') }}" 
                   class="{{ Request::is('kasir') || Request::is('kasir/index') ? 'active' : '' }}"
            ...
            <li>
                <a href="{{ route('kasir.penjualan') }}" 
                   class="{{ Request::is('kasir/penjualan*') || Request::is('penjualan*') ? 'active' : '' }}"
                   data-tooltip="Kelola Penjualan">
                    <span class="menu-icon">🎁</span>
    ...
    <div class="sidebar-footer">
        <a href="{{ route('logout') }}" class="logout-btn" onclick="event.preventDefault(); document.getElementById('logout-form-sidebar-kasir').submit();">
            <span class="logout-icon">🚪</span>
            <span>Log Out</span>
        </a>
        <form id="logout-form-sidebar-kasir" action="{{ route('logout') }}" method="POST" style="display: none;">
            @csrf
        </form>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (sidebar && !sidebar.dataset.initialized) {
            ...
            console.log('✅ Kasir sidebar loaded (Fixed: admin.cms.* routes)');
            ...
            console.log('✅ Kasir sidebar fully initialized');
        }
    });
</script>